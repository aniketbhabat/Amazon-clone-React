      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center mt-6">
          <div className=" flex items-center justify-center">
            <span className=" font-mono text-white">Project Made By AniketBhabat</span>
          </div>
          <div className="w-full h-auto py-8 flex items-center justify-center gap-8 flex-wrap">

            
            <a
              href="https://www.linkedin.com/in/aniketbhabat"
              target="_blank"
            ...
            <a href="mailto:aniketbhabat7050@gmail.com">
              <button className="w-12 h-12 flex items-center justify-center rounded-lg bg-white hover:shadow-md hover:shadow-gray-200 group transition-all duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="36"
            ...
            <a href="https://github.com/aniketbhabat">
              <button className="w-12 h-12 flex items-center justify-center rounded-lg bg-white hover:shadow-md hover:shadow-gray-200 group transition-all duration-300">
                <svg
                  viewBox="0 0 16 16"
                  version="1.1"
